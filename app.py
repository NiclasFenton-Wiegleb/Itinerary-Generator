...
Check out this AI generator to plan your day out!\n It gives you an itinerary starting with brunch, then a fun activity, afternoon drinks,
...
with col2:
    with st.container():
        ...
        button = st.button("Generate", on_click=select_route)
